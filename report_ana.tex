...
\subsection{Part 5: Hedge using actual copper futures}
...
\subsection{Part 5: Hedge using a synthetic derivative with corr $\approx 0.75$ to costs}
...
\subsection{Part 6: Correlation sensitivity analysis (synthetic derivative)}
...
\subsection{Part 6: EBIT VaR/ETL across correlations}
